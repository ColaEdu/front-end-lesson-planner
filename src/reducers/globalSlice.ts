...
export const { settext, seteditId, setAIloading, setaiActive, setaskAI, setaskAISelection, setaskAIAdvicePrompt, setaskAIAdvice, setAIAdviceWriting, setAIAdviceGenerating } = globalSlice.actions;
